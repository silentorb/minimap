...
- **Prototype exception:** placed vegetables may use game-icons SVGs as world **texture** depictions until dedicated crop SpriteFrames exist (see [cell-placement.md](../gameplay/cell-placement.md)).

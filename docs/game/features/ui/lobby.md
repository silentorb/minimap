...
Local multiplayer join screen before a match. Related: [local-input.md](../session/local-input.md), [player-hud.md](player-hud.md), [players.md](../session/players.md), [accessories.md](../gameplay/accessories.md), [tags.md](../gameplay/tags.md), [main-menu.md](main-menu.md).
...
Loading `res://scenes/world.tscn` directly (without lobby) still starts a game for developers and automated tests; see [local-input.md](../session/local-input.md). Direct world entry creates players with default accessory points and **no** selected accessories.

...
- A **character** is a runtime pawn (resources including health, position, faction, accessories/effects) plus a **character definition** that describes what to spawn.

...
- Short-term: one **generic** character definition is used for all spawned characters (humans and rivals). That definition includes the **Gun** accessory (see [accessories.md](accessories.md), [combat.md](combat.md)).

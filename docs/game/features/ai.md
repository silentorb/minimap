...
- AI characters **engage hostiles** using the same combat rules as a player-controlled character from the character’s point of view: [combat.md](combat.md) `ShootEffect` firing, with aim toward the nearest hostile faction member.

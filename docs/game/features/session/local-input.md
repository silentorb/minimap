...
Input devices for local human players. Related: [lobby.md](../ui/lobby.md), [main-menu.md](../ui/main-menu.md), [movement.md](../gameplay/movement.md), [player-hud.md](../ui/player-hud.md), [combat.md](../gameplay/combat.md), [active-abilities.md](../gameplay/active-abilities.md).
...
- **Lobby profile confirm / ready**: Selecting profile — `JoyButton.A` or `JoyButton.Start`, keyboard **Enter** or **Space**. Selecting accessories — `JoyButton.Start` / keyboard **Enter** ready up; Space / A take or return accessories.

...
Vitality from [hunger.md](hunger.md) can heal or hurt health over time based on energy bands. Player health is shown on the local HUD as part of the resource list; see [player-hud.md](../ui/player-hud.md) and [resources.md](resources.md).

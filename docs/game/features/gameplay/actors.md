...
General runtime entities in the world. Related: [characters.md](characters.md), [accessories.md](accessories.md), [farming.md](farming.md), [interaction.md](interaction.md), [cell-placement.md](cell-placement.md), [depiction.md](depiction.md). Technical: [actors.md](../../../technical/features/gameplay/actors.md).

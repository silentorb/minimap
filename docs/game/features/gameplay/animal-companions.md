...
- Companion characters mirror **zombie** loadout and AI for now: energy upkeep, movement energy, Eat, Swing; default aggression (**0.45**); nearest-hostile combat. They do **not** attack the owning player (same faction).
...
- Per-species unique combat kits or follow/leash behavior

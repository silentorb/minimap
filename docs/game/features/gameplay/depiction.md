...
How content definitions describe presentation without coupling simulation to Godot sprites. Technical: [depiction.md](../../../technical/features/gameplay/depiction.md).
...
- Accessory visuals attached to the pawn (equip overlay). Data-record / HUD icons are [ui-icons](../ui/ui-icons.md), not depiction.

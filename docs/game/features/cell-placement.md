...
- **Geek** (CompuQuest): modal ability; place effect costs **computers**; places a **computer** actor on an **unoccupied Grass** cell in front of the player. With Geek selected, environment interact targets a computer in the front cell (further computer behavior forthcoming).

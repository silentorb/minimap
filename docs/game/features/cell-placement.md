...
Placing cell-anchored **actors** on map **cells** (spatial partitions). Related: [actors.md](actors.md), [active-abilities.md](active-abilities.md), [accessories.md](accessories.md), [farming.md](farming.md), [map-layout.md](map-layout.md), [depiction.md](depiction.md). Technical: [../../technical/features/cell-placement.md](../../technical/features/cell-placement.md).
...
- **Geek** (CompuQuest): modal ability; place effect costs **electronics**; places a **computer** actor on an **unoccupied Grass** cell in front of the player. With Geek selected, environment interact targets a computer in the front cell (further computer behavior forthcoming).

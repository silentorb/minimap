...
- **Geek** (CompuQuest): modal ability; place effect costs **computers**; places a **computer** actor on an **unoccupied Grass** cell in front of the player (no further computer behavior yet).

...
Actor-owned amounts keyed by tags, plus registered resource types. Related: [tags.md](tags.md), [health.md](health.md), [accessories.md](accessories.md), [farming.md](farming.md), [player-hud.md](player-hud.md). Technical: [../../technical/features/resources.md](../../technical/features/resources.md).
...
- Shipped CompuQuest types: `health`, `max_health`, `computers`, `seeds`, `ammo`, `food`. Acquire grants: **Geek** → computers (1), **Farm** → seeds (3), **Gun** → ammo (6). Harvest yields food (carrot 1 / corn 2 / melon 3).

## Non-goals (for now)

- Fixed numeric limits on resource types
- Ways to refill ammo / seeds / computers after grant
- Spending / eating food

...
Named labels on game data (e.g. which accessories players may choose, which resource types a character holds, which **domain** themes apply). Technical: [../../technical/features/tags.md](../../technical/features/tags.md). Related: [resources.md](resources.md), [domains.md](domains.md).

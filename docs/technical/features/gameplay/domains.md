...
Tagged theme records and domain-colored UI icons. Implements [domains.md](../../../game/features/gameplay/domains.md). Related: [tags.md](tags.md), [accessories.md](accessories.md), [ui-icons.md](../ui/ui-icons.md), [definition-config.md](../platform/definition-config.md), [extensions.md](../platform/extensions.md), [player-hud.md](../ui/player-hud.md), [lobby.md](../ui/lobby.md).

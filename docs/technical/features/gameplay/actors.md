...
Actor definition vs instance contracts. Implements [actors.md](../../../game/features/gameplay/actors.md). Related: [characters.md](characters.md), [characters-and-factions.md](characters-and-factions.md), [accessories.md](accessories.md), [cell-placement.md](cell-placement.md), [definition-config.md](../platform/definition-config.md), [depiction.md](depiction.md).

...
- **`GameWorld.Tick(dt)` order**: controllers → apply movement (updates **Facing**) → tick projectiles → tick swing arcs (lifetime) → apply damage / remove dead characters and cell actors.

...
Ability loadout and activation wiring. Implements [../../game/features/active-abilities.md](../../game/features/active-abilities.md). Related: [cell-placement.md](cell-placement.md), [accessories.md](accessories.md), [controllers.md](controllers.md), [local-input.md](local-input.md), [definition-config.md](definition-config.md).
...
- **`PlayerController`**: feeds fire held, modal select, ability activate/back edges; owns placement preview state for modal `ICellPlacementEffect`s.

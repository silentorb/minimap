...
Occupancy and placement APIs. Implements [../../game/features/cell-placement.md](../../game/features/cell-placement.md). Related: [actors.md](actors.md), [active-abilities.md](active-abilities.md), [accessories.md](accessories.md), [farming.md](farming.md), [hex-grid-shape.md](hex-grid-shape.md), [depiction.md](depiction.md).

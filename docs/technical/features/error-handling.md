...
Cross-cutting standards for product and agent-authored code. Feature docs may still define specific fail-fast or abort contracts (e.g. [lobby.md](lobby.md), [core-settings.md](core-settings.md), [extensions.md](extensions.md)); this file is the shared policy for **how** to choose and wire failures.

...
Opaque UI icon references on content definitions. Implements [../../game/features/ui-icons.md](../../game/features/ui-icons.md). Related: [definition-config.md](definition-config.md), [depiction.md](depiction.md), [resources.md](resources.md), [player-hud.md](player-hud.md), [domains.md](domains.md).
...
- Domain-tagged accessories use Client **`DomainIconView`** (colored swatch + transparent-bg glyph); see [domains.md](domains.md).

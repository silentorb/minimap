...
- **Boot**: ordered via `LobbySceneBoot` — (1) bind panels and refresh UI, (2) preflight-load `extensions.json` (same as world), (3) only then accept input. Unit tests cover each step and abort.

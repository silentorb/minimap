...
- **Screen scene**: `res://scenes/main_menu.tscn` — root `MainMenuApp` under `Minimap.Client.MainMenu`. Full-rect black background, title label `CompuQuest Mini`, **New** / **Quit** controls.

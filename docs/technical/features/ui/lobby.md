...
Implements [lobby.md](../../../game/features/ui/lobby.md). Related: [local-input.md](../session/local-input.md), [local-play-context.md](../session/local-play-context.md), [players.md](../session/players.md), [accessories.md](../gameplay/accessories.md), [tags.md](../gameplay/tags.md).
...
- **Navigation**: when start gate passes, write [`LocalPlayContext`](../session/local-play-context.md) roster (devices + selected accessories) and `ChangeSceneToFile("res://scenes/world.tscn")`.

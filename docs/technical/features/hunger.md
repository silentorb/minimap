...
Energy resources, upkeep drain/vitality, and food-gated Eat. Implements [../../game/features/hunger.md](../../game/features/hunger.md). Related: [resources.md](resources.md), [accessories.md](accessories.md), [active-abilities.md](active-abilities.md), [player-hud.md](player-hud.md), [farming.md](farming.md), [definition-config.md](definition-config.md), [characters.md](characters.md), [controllers.md](controllers.md).
...
- HUD: selected modal ability icon/name comes from the filtered loadout (disabled Eat omitted); see [player-hud.md](player-hud.md).

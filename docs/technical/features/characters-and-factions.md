...
Simulation character model and faction APIs. Implements [../../game/features/factions.md](../../game/features/factions.md) and [../../game/features/health.md](../../game/features/health.md). Related: [characters.md](characters.md), [accessories.md](accessories.md), [resources.md](resources.md), [controllers.md](controllers.md).

...
Accessory definitions, instances, and actor effect cache. Implements [../../game/features/accessories.md](../../game/features/accessories.md). Related: [actors.md](actors.md), [characters.md](characters.md), [controllers.md](controllers.md), [active-abilities.md](active-abilities.md), [cell-placement.md](cell-placement.md), [farming.md](farming.md), [resources.md](resources.md), [extensions.md](extensions.md), [definition-config.md](definition-config.md), [depiction.md](depiction.md), [tags.md](tags.md), [players.md](players.md), [hunger.md](hunger.md).

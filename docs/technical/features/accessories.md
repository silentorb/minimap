...
- Types in **`Minimap.Simulation.Types`**:
  ...
  - **`AutoshootEffect`** — fire interval, missile speed, damage, and runtime `CooldownRemaining`.
...
- Simulation systems (e.g. autoshoot) read **`character.Effects`**, not accessory trees.
- CompuQuest registers **Gun** (`AutoshootEffect` with combat doc values: interval **1.25** s, speed **200**, damage **25**).

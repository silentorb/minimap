...
Simulation `Player` records and client controller association. Implements [../../game/features/players.md](../../game/features/players.md). Related: [controllers.md](controllers.md), [lobby.md](lobby.md), [core-settings.md](core-settings.md), [accessories.md](accessories.md).

...
- Load timing: early host composition (`AppHostRegistration` ModuleInitializer) before main-menu/lobby/world `_Ready`.
...
| `START_SCREEN` | First screen after boot | Env only. Trimmed value `lobby` → lobby scene; unset / any other value → main menu screen (see [main-menu.md](../ui/main-menu.md)) |

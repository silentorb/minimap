...
- Definition / content bag types that Simulation and extensions both need (`AccessoryDefinition`, `ActorDefinition`, `ResourceDefinition`, `DomainDefinition`, `ColorRgb`, `SpawnerDefinition`, `DepictionConfig`, `IconConfig`, `GameContent`, `TagId`, `TagRegistry`, `WeightedPool`, `DomainColorResolver`, …)

...
- Definition / content bag types that Simulation and extensions both need (`AccessoryDefinition`, `CharacterDefinition`, `SpawnerDefinition`, `DepictionConfig`, `IconConfig`, `GameContent`, `TagId`, `TagRegistry`, `WeightedPool`, …)
